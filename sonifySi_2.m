% Sonification of Silicon Electron Configuration Including 
clear all
close all
...
scaling_factor = 44.1e3; %sampling of human ear

% Convert energies to frequencies within audible range
freq_1s = 1/energy_1s * scaling_factor;
freq_2s = 1/energy_2s * scaling_factor;
freq_2p = 1/energy_2p * scaling_factor;
freq_3s = 1/energy_3s * scaling_factor;
freq_3p = 1/energy_3p * scaling_factor;
